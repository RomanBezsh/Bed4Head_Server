...
{
    /// <inheritdoc />
    public partial class UpdateUserAndFixes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<bool>(
                name: "NewsAcrossWorld",
                table: "Users",
                type: "boolean",
                nullable: true);

            migrationBuilder.AddColumn<bool>(
                name: "NewsAffordableTravel",
                table: "Users",
                type: "boolean",
                nullable: true);

            migrationBuilder.AddColumn<bool>(
                name: "NewsFavoriteCities",
                table: "Users",
                type: "boolean",
                nullable: true);

            migrationBuilder.AddColumn<bool>(
                name: "NewsSeasonalOffers",
                table: "Users",
                type: "boolean",
                nullable: true);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelType = table.Column<string>(type: "text", nullable: false),
                    ...
                    HotelChainId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelFaqs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelFaqs_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Facilities = table.Column<double>(type: "double precision", nullable: false),
                    Staff = table.Column<double>(type: "double precision", nullable: false),
                    Cleanliness = table.Column<double>(type: "double precision", nullable: false),
                    Comfort = table.Column<double>(type: "double precision", nullable: false),
                    Location = table.Column<double>(type: "double precision", nullable: false),
                    ValueForMoney = table.Column<double>(type: "double precision", nullable: false),
                    HotelId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Url = table.Column<string>(type: "text", nullable: false),
                    IsPreview = table.Column<bool>(type: "boolean", nullable: true),
                    RoomId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
