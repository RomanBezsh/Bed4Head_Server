...
public class BookingServiceTests
{
    ...
    public async Task CreateBooking_ShouldAdd()
    {
        ...
        var user = new Bed4Head.DAL.Entities.User { Id = Guid.NewGuid(), Email = "u@example.com", PasswordHash = "x", PasswordSalt = "" };
        await uow.Users.AddAsync(user);
        var hotel = new Bed4Head.DAL.Entities.Hotel { Id = Guid.NewGuid(), Name = "H", Description = "d", Stars = 3, Address = "a", City = "c", Latitude = 0, Longitude = 0, HotelType = "t" };
        await uow.Hotels.AddAsync(hotel);
        var room = new Bed4Head.DAL.Entities.Room { Id = Guid.NewGuid(), HotelId = hotel.Id, Price = 10 };
